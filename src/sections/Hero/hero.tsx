...
export default function HeroSection() {
  const commonParagraphStyles = 'text-gray-dark dark:text-gray-main font-roboto text-base sm:text-xl md:text-2xl';
